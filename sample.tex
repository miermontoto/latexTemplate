...
\begin{table}
    ...
    \begin{tabularx}{\textwidth}{lXr}
        \toprule
            Columna fija & Columna flexible & Valor \\ \midrule
         Elemento 1 & Este texto se expande para llenar el ancho de la página & 42 \\
         Elemento 2 & La columna X se ajusta automáticamente & 17 \\
         Elemento 3 & Útil para tablas con contenido de longitud variable & 99 \\
        \bottomrule
    \end{tabularx}
    \caption{Tabla con tabularx (ancho completo)}
    \label{tab:tab2}
\end{table}
