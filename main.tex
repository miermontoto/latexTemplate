...
\usepackage{newtxtext} % Times New Roman (reemplazo moderno de mathptmx)
\usepackage{newtxmath}

\usepackage[spanish, es-tabla, es-noshorthands]{babel} % Permite escritura en castellano
